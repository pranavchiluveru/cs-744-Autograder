...
int main(int argc, char* argv[]) {
    ...
    cout << "Total Loop Time: " << (loopet_ms-loopst_ms) << " milliseconds" << endl;
    ...
    cout << "Request sent rate: "<<1000*loopNum/loopTime<<endl;
    cout << "Successful request rate: "<<1000*successfulResponses/loopTime<<endl;
    cout << "Timeout rate: "<<1000*numTimeouts/loopTime<<endl;
    cout << "Error rate: "<<1000*numErrors/loopTime<<endl;
